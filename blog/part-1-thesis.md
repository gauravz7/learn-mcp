...
The same key light, the same screen direction, the same 180° line, cut after cut. The value — and the
difficulty — is not in any single frame. It is in the *agreement between frames*.
