...
**[Foundations: MCP and Skills](index.html)** — how capability and craft compose, the protocol
details, and the context economics. Or revisit **[Part 1 — the thesis](part-1-thesis.html)** ·
