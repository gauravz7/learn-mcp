...
_BASE_INSTRUCTION = (
        ...
        "establish_scene → generate_microshot(project_id, scene_id, panels=N, beats=[N agreed beats]) "
        ...
        "beats=[N beats as {action, emotion, speaker}]) to render the scene's N-frame storyboard image. "
        "Call it with ONLY user_id/project_id/scene_id/panels/beats — no long `prompt`; keep each beat a short "
